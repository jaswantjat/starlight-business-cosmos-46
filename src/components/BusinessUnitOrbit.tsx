      ...
      {units.length > 0 && (
        <>
          ...
          >
            ...
            {/* Tech grid overlay */}
            <div className="absolute inset-0 tech-grid-overlay opacity-30 rounded-full"></div>

            {/* Company name in center */}
            {companyName && (
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-cosmic-neon-green text-xs font-display tracking-wider text-glow-green">
                  {companyName}
                </div>
              </div>
            )}
            ...
            <div className="absolute inset-0 overflow-hidden rounded-full">
              <div className="absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-cosmic-neon-green/40 to-transparent animate-circuit-flow"></div>
              <div className="absolute top-1/2 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-cosmic-neon-green/40 to-transparent animate-circuit-flow" style={{ animationDelay: '2s' }}></div>
            </div>
          </div>
          ...
          <div ref={orbitContainerRef} className="relative w-full h-full flex items-center justify-center">
            {units.map((unit, index) => (
              <div
                ...
                className={cn(
                  "absolute node-card rounded-lg p-4 shadow-lg transform",
              ...
              >
                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-3 rounded-md backdrop-blur-sm bg-black/30">
                  ...
                  <div className="absolute top-2 left-2 w-2 h-2 rounded-full bg-cosmic-neon-green animate-node-pulse"></div>
                  ...
                  <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-30">
                    <div className="absolute inset-0 w-full h-[1px] bg-cosmic-neon-green/20 animate-scan-line"></div>
                  </div>
                  ...
                  {/* Top border glow */}
                  <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-cosmic-neon-green/40 to-transparent"></div>
                </div>
              </div>
            ))}
          </div>
