...
const CompanyInput: React.FC<CompanyInputProps> = ({
  ...
  return <div ref={containerRef} className="w-full max-w-md mx-auto relative perspective-container">
      ...
      <div className="relative">
        ...
        <div className="mb-8 text-center">
          <h1 ref={titleRef} className="text-4xl md:text-6xl font-bold mb-3 font-display tracking-tight" data-text="Business Unit Visualizer">
        ...
        <div ref={panelRef} className="glass-panel-dark rounded-xl p-8 border border-cosmic-neon-green/10 relative overflow-hidden shadow-lg">
          ...
          <div className="relative z-10">
            <label htmlFor="company-name" className="block mb-3 text-sm font-medium text-cosmic-neon-green font-display tracking-wide">
              COMPANY NAME
            </label>
            <div className="flex gap-3">
              <Input ref={inputRef} id="company-name" className="bg-black/30 border-cosmic-neon-green/30 focus:border-cosmic-neon-green focus:ring-1 focus:ring-cosmic-neon-green/50 text-white placeholder:text-gray-400 rounded-lg h-12" value={companyName} onChange={e => setCompanyName(e.target.value)} onKeyDown={handleKeyDown} placeholder="Enter company name..." />
              <Button onClick={handleGenerate} className="glass-button hover:bg-cosmic-neon-green/40 text-white font-medium px-6 h-12 rounded-lg transition-all">
